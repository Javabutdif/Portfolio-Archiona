...
6. Mark the corresponding Persona Task as completed.
...
After implementation, set `currentPersona: qa` and trigger `archiona validate`.
If validation fails, fix errors and re-validate. Do not declare done until
validate returns 0.
